<template>
    <header
        class='flex shadow-md px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
        <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
            <a href="#"><img src="/logo.png" alt="logo" class='w-28' />
            </a>
            ...
            <div id="collapseMenu"
                ...
                <ul
                    ...
                    <li class='max-lg:border-b border-gray-300 max-lg:py-3 px-3'>
                        <a href='#' class='hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>Home</a>
                    </li>
